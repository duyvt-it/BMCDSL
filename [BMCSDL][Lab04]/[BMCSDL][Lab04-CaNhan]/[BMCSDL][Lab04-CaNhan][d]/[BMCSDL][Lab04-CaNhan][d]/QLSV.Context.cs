...
namespace _BMCSDL__Lab04_CaNhan__d_
{
    ...
    public partial class QLSVEntities : DbContext
    {
        ...
        public virtual int SP_UPD_ENCRYPT_NHANVIEN(string mANV, string hOTEN, string eMAIL, string lUONG)
        {
            var mANVParameter = mANV != null ?
                new ObjectParameter("MANV", mANV) :
                new ObjectParameter("MANV", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_UPD_ENCRYPT_NHANVIEN", mANVParameter, hOTENParameter, eMAILParameter, lUONGParameter);
        }
    }
}
